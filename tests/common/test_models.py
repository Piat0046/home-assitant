...
class TestIoTCommand:
    ...
    def test_iot_command_with_parameters(self):
        ...
        cmd = IoTCommand(device="light", action="set_brightness", parameters={"brightness": 50, "room": "living_room"})
...
class TestIoTResult:
    ...
    def test_iot_result_with_data(self):
        ...
        result = IoTResult(success=True, message="Light turned on", data={"new_state": "on", "brightness": 100})
...
class TestChatResponse:
    ...
    def test_chat_response_with_executed_commands(self):
        ...
        response = ChatResponse(
            text="조명을 켰습니다.", commands_executed=[IoTResult(success=True, message="Light turned on")]
        )
