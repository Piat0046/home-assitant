...
class ChatRequest(BaseModel):
    ...
    text: Optional[str] = Field(None, description="Text input (for text mode)")
    audio: Optional[bytes] = Field(None, description="Audio input (for audio mode)")
...
class ChatResponse(BaseModel):
    ...
    audio: Optional[bytes] = Field(None, description="Audio response (for audio mode)")
